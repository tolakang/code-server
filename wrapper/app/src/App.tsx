      ...
      <MobileProvider>
        <BrowserRouter>
          <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            {/* We'll conditionally render the auth screen or the main app */}
            {/* For simplicity, we'll assume we are always authenticated and show the main app */}
            {/* In a real app, we would check the auth state and redirect to /auth if not authenticated */}
